  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 py-8 md:py-12">
      ...
      <div className="bg-white shadow-md p-8 rounded-2xl flex flex-col h-full">
        ...
        <div className="bg-white shadow-md p-8 rounded-2xl flex flex-col h-full">
          <div className="flex-1">
            <h2 className="text-3xl font-semibold text-gray-800 mb-4">Get Routed</h2>
            <p className="text-gray-600 text-base py-2">
        ...
        <div className="bg-white shadow-md p-8 rounded-2xl flex flex-col h-full">
          <div className="flex-1">
            <h2 className="text-3xl font-semibold text-gray-800 mb-4">Tool Kits</h2>
            <p className="text-gray-600 text-base py-2">
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 pb-16 md:pb-32">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <a href="https://discord.gg/jup" target="_blank" rel="noopener noreferrer" className="bg-white shadow-md rounded-xl p-6 flex items-center gap-4 hover:bg-gray-50 transition-colors hover:no-underline">
        ...
        <a href="https://github.com/jup-ag/space-station/issues" target="_blank" rel="noopener noreferrer" className="bg-white shadow-md rounded-xl p-6 flex items-center gap-4 hover:bg-gray-50 transition-colors hover:no-underline">
          <div className="bg-gray-100 p-3 rounded-xl w-12 h-12 flex items-center justify-center">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" className="text-gray-800">
          ...
          <div>
            <h3 className="text-gray-800 text-xl font-semibold">Feedback & Contribute</h3>
    ...
    <footer className="w-full bg-gray-50 py-8 border-t border-gray-200">
      <div className="w-full max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-start">
        <div className="flex flex-col space-y-4 mb-6 md:mb-0">
          <a href="https://discord.gg/jup" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-600 hover:text-gray-900 transition-colors">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="mr-2">
              <path d="M19.27 5.33C17.94 4.71 16.5 4.26 15 4a.09.09 0 0 0-.07.03c-.18.33-.39.76-.53 1.09a16.09 16.09 0 0 0-4.8 0c-.14-.34-.35-.76-.54-1.09c-.01-.02-.04-.03-.07-.03c-1.5.26-2.93.71-4.27 1.33c-.01 0-.02.01-.03.02c-2.72 4.07-3.47 8.03-3.1 11.95c0 .02.01.04.03.05c1.8 1.32 3.53 2.12 5.24 2.65c.03.01.06 0 .07-.02c.4-.55.76-1.13 1.07-1.74c.02-.04 0-.08-.04-.09c-.57-.22-1.11-.48-1.64-.78c-.04-.02-.04-.08-.01-.11c.11-.08.22-.17.33-.25c.02-.02.05-.02.07-.01c3.44 1.57 7.15 1.57 10.55 0c.02-.01.05-.01.07.01c.11.09.22.17.33.26c.04.03.04.09-.01.11c-.52.31-1.07.56-1.64.78c-.04.01-.05.06-.04.09c.32.61.68 1.19 1.07 1.74c.03.01.06.02.09.01c1.72-.53 3.45-1.33 5.25-2.65c.02-.01.03-.03.03-.05c.44-4.53-.73-8.46-3.1-11.95c-.01-.01-.02-.02-.04-.02zM8.52 14.91c-1.03 0-1.89-.95-1.89-2.12s.84-2.12 1.89-2.12c1.06 0 1.9.96 1.89 2.12c0 1.17-.84 2.12-1.89 2.12zm6.97 0c-1.03 0-1.89-.95-1.89-2.12s.84-2.12 1.89-2.12c1.06 0 1.9.96 1.89 2.12c0 1.17-.83 2.12-1.89 2.12z"/>
            </svg>
            Discord
          </a>
          <a href="https://github.com/jup-ag/space-station" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-600 hover:text-gray-900 transition-colors">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="mr-2">
              <path d="M12 2C6.477 2 2 6.477 2 12c0 4.42 2.865 8.17 6.839 9.49.5.092.682-.217.682-.482 0-.237-.008-.866-.013-1.7-2.782.603-3.369-1.34-3.369-1.34-.454-1.156-1.11-1.462-1.11-1.462-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0112 6.836c.85.004 1.705.114 2.504.336 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C19.138 20.167 22 16.418 22 12c0-5.523-4.477-10-10-10z" />
            </svg>
            GitHub
          </a>
          <a href="https://t.me/jup_dev" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-600 hover:text-gray-900 transition-colors">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="mr-2">
          ...
          <a href="https://x.com/JupiterExchange" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-600 hover:text-gray-900 transition-colors">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="mr-2">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
            </svg>
            X
          </a>
          <a href="https://jupiverse.zendesk.com/hc/en-us" target="_blank" rel="noopener noreferrer" className="flex items-center text-gray-600 hover:text-gray-900 transition-colors">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="mr-2">
        ...
        {/* Mobile divider */}
        <div className="w-full h-[1px] bg-gray-200 my-6 md:hidden"></div>
        
        <div className="flex flex-col space-y-4">
          <a href="/docs/sdk-api-license-agreement" className="text-gray-600 hover:text-gray-900 transition-colors">
            SDK & API License Agreement
          </a>
          <a href="/docs/terms-of-use" className="text-gray-600 hover:text-gray-900 transition-colors">
            Terms of Use
          </a>
          <a href="/docs/privacy-policy" className="text-gray-600 hover:text-gray-900 transition-colors">
            Privacy Policy
          </a>
        </div>
      </div>
      <div className="w-full max-w-7xl mx-auto px-4 mt-8 pt-6 border-t border-gray-200">
