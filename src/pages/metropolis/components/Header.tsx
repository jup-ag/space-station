                    ...
                    <div className='w-full'>
                        <div className="w-full h-screen flex flex-col overflow-auto gap-2 items-center pt-6 bg-gradient-to-b from-[#223345] to-[#131C25] md:bg-transparent md:from-transparent md:to-transparent">
                            ...
                            {LINKS.map((link) => {
                                if (link.style === 'button') {
                                    return (
                                        <a href={link.path} key={link.label} rel="noopener noreferrer" className="bg-[#c7f284]/30 border border-solid border-transparent rounded-2xl text-center py-1.5 px-6 m-0 mt-4 hover:border-[#c7f284] hover:no-underline transition-colors ease-out duration-200">
                                            <span className="text-sm font-semibold inline-block text-[#c7f284]">
                                                {link.label}
                                            </span>
                                        </a>
                                    );
