...
The number of new tokens being added is increasing at an ever faster pace. Jupiter automatically lists any tokens as long as their have [reached enough liquidity](../apis/token-list/getting-tokens-on-jup). This means you can be assured that you'll be able to trade new tokens as they launch on Solana.
